...
if (isset($_SESSION["customerloggedin"]) && $_SESSION["customerloggedin"] == true) {
  header("location: shoplist.php"); //Redirecting to shoplist
}else if (isset($_SESSION["adminloggedin"]) && $_SESSION["adminloggedin"] == true) {
    header("location: ../admin/admindashboard.php"); //Redirecting to myrestaurant Page
  }
if (isset( $_GET['error'])) {
    $errorNo = $_GET['error'];
    switch( $errorNo) {
            ...
            <div class="form login">
                ...
                <form action="../../controller/FrontHandler.php" method="post"> 
                    ...
                    <div class="input-field button">
                        <input type="submit" name="customerlogin" value="Masuk">
                    </div>
                </form>
                <?php
                if(!empty($errors)): ?>
                ...
                <div class="login-signup">
                    <span class="text">Belum daftar?
                        <a href="usersignup.php" class="text signup-link">Daftar sekarang!</a>
                    </span>
                </div>
            </div>
